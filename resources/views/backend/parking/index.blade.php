<x-dashboard.layout>
    <section class="h-screen">
        ...
        <section class="">
            ...
            <form action="{{route('parking.store')}}"
                  method="POST">
                @csrf
                <section class="bg-blue-200 space-y-4 p-8">
                    ...
                    {{--            </section>--}}
                    <button type="submit" class="bg-yellow-200 p-4 w-full text-center">Check In</button>
                </section>
            </form>
                        ...
                        @foreach($vehicles as $vehicle)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <th scope="row"
                                    ...
                                    <a href="{{route('parking.show', $vehicle)}}"> {{$vehicle->unique_code}}</a>
                                </th>
                                <td class="py-4 px-6">
